...
public class About implements ICommand<MessageReceivedEvent>
{
	...
	{
		Util.msg(event.getMessage().getChannel(), "**About: **Maunz is an IRC bot created by Vauff | **Version: **" + Main.version + " | " + "**Build Date: **" + getBuildDate() + " | " + "**Dev Mode: **" + StringUtils.capitalize(Boolean.toString(Util.devMode)) + " | " + "**Uptime: **" + Util.getUptime());
	}
