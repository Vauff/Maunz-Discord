...
public class CSGOUpdatesEditChannel extends AbstractMenuPage
{
	private boolean retry;

	public CSGOUpdatesEditChannel(MessageReceivedEvent trigger, AbstractCommand<MessageReceivedEvent> cmd)
	{
		super(trigger, cmd);
	}
	...
	public void onReplied(MessageReceivedEvent event) throws Exception
	{
		...
		if (!message.equals(""))
		{
			...
			show(new CSGOUpdatesEditPage(trigger, cmd));
		}
		else
		{
			retry = true;
